...
import com.iboot.weixin.bean.Delivernotify;
import com.iboot.weixin.bean.pay.OrderInfo;
import com.iboot.weixin.bean.pay.Orderquery;
...
public class PayAPI extends BasePayAPI {
	 ...
	 * @return
	 */
	private static BaseResult payDelivernotify(String access_token,
		...
		HttpUriRequest httpUriRequest = RequestBuilder
				...
				.setEntity(
						new StringEntity(delivernotifyJson, Charset
								.forName("utf-8"))).build();
	 ...
	 * @return
	 */
	public static BaseResult payfeedbackUpdate(String access_token,
			String openid, String feedbackid) {
	 ...
	 * @return
	 */
	private static OrderInfo payOrderquery(String access_token,
			String orderqueryJson) {
		HttpUriRequest httpUriRequest = RequestBuilder
				.post()
				.setHeader(jsonHeader)
				...
				.addParameter("access_token", access_token)
				.setEntity(
						new StringEntity(orderqueryJson, Charset
								.forName("utf-8"))).build();
		return LocalHttpClient.executeJsonResult(httpUriRequest,
				OrderInfo.class);
	}
	 ...
	 * @return
	 */
	public static BaseResult payDelivernotify(String access_token,
			Delivernotify delivernotify, String paySignKey) {
	 ...
	 * @return
	 */
	public static OrderInfo payOrderquery(String access_token,
			Orderquery orderquery, String paySignKey) {
